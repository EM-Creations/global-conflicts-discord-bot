...
import { ChatInputCommandInteraction, ClientEvents, TextChannel } from "discord.js";
import permissionCheck from "src/helpers/restart_stop_command_perms_check";

@SubCommand({ name: 'fantasy', description: 'Starts/Restarts the Fantasy event test server', })
export class FantasyTestServerSubCommand {
